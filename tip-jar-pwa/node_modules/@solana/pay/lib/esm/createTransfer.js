import { createTransferCheckedInstruction, getAccount, getAssociatedTokenAddress, getMint, TOKEN_2022_PROGRAM_ID, TOKEN_PROGRAM_ID, } from '@solana/spl-token';
 ...
 */
export async function createTransfer(connection, sender, { recipient, amount, splToken, reference, memo }, { commitment } = {}) {
