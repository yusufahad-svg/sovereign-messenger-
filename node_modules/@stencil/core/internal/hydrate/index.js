...
var initializeClientHydrate = (hostElm, tagName, hostId, hostRef) => {
  ...
  if (BUILD8.shadowDom && shadowRoot && !shadowRoot.childNodes.length) {
    let rnIdex = 0;
...
var setAccessor = (elm, memberName, oldValue, newValue, isSvg, flags, initialRender) => {
  ...
  if (BUILD12.vdomClass && memberName === "class") {
    ...
    return;
  } else if (BUILD12.vdomPropOrAttr && memberName[0] === "p" && memberName.startsWith("prop:")) {
    const propName = memberName.slice(5);
    try {
...
var bootstrapLazy = (lazyBundles, options = {}) => {
  ...
  if (cmpTags.length > 0) {
    if (BUILD22.slotRelocation && hasSlotRelocation) {
...
var baseClass = BUILD24.lazyLoad ? class {
...
// src/hydrate/platform/index.ts
import { BUILD as BUILD26, Env, NAMESPACE as NAMESPACE2 } from "@stencil/core/internal/app-data";
var customError;
...
var supportsShadow = BUILD25.shadowDom;
...
var registerInstance = (lazyInstance, hostRef) => {
  ...
  if (hostRef.$cmpMeta$.$flags$ & 512 /* hasModernPropertyDecls */ && (BUILD25.state || BUILD25.prop)) {
...
var setScopedSSR = (opts) => {
  scopedSSR = BUILD25.shadowDom && opts.serializeShadowRoot !== false && opts.serializeShadowRoot !== "declarative-shadow-dom";
};
